                                ...
                                <div class="main-menu d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a href="{{route('rent-car.index')}}">Rent Car</a></li>
...
<main>
                ...
                <div class="col-lg-10 posts-list">
                    <div class="single-post">
                        ...
                        <div class="blog_details">
                            ...
                            <p class="excert">
                                In this service we are rent cars for people in what we have of cars, customer can rent
                                whatever car he/she want from what we have, we have a lot of cars to make sure that
                                every customer found what they want.
                            </p>
                            <p>
            ...
            <div class="row">
                <div class="cl-xl-7 col-lg-8 col-md-10">
                    ...
                    <div class="section-tittle mb-70">
                        <span>Our Cars </span>
                        <h2>Some cars that can you rent</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <a href="{{route('rent-car.show',['1'])}}"><img src="assets/img/car1.jpg" alt=""
                                                                            style="height: 300px"></a>
                        </div>
                        <div class="team-caption">
                            <h3><a href="{{route('rent-car.show',['1'])}}">BMW Car</a></h3>
                            <span>2000 Modal</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <a href="{{route('rent-car.show',['2'])}}">
                                <img src="assets/img/car2.jpg" alt="" style="height: 300px">
                            </a>
                        </div>
                        <div class="team-caption">
                            <h3><a href="{{route('rent-car.show',['2'])}}">KIA Car</a></h3>
                            <span>2000 Modal</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <a href="{{route('rent-car.show',['3'])}}">
                                <img src="assets/img/car3.jpg" alt="" style="height: 300px">
                            </a>
                        </div>
                        <div class="team-caption">
                            <h3><a href="{{route('rent-car.show',['3'])}}">Mercedes</a></h3>
                            <span>2001 Modal</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="wantToWork-area w-padding2 section-bg" data-background="assets/img/gallery/section_bg03.jpg"
             style="background-image: url('assets/img/gallery/section_bg03.jpg')">
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-xl-7 col-lg-9 col-md-8">
                    <div class="wantToWork-caption wantToWork-caption2">
                        <h2>Are you Searching<br> At Car To Rent?</h2>
                    </div>
                </div>
                <div class="col-xl-2 col-lg-3 col-md-4">
                    <a href="{{route('rent-car.create')}}" class="btn btn-black f-right">Get Your Car Now</a>
                </div>
            </div>
        </div>
    </section>
