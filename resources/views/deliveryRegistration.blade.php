                        ...
                        <form action="{{route('delivery.store')}}" method="POST">
                            ...
                            <div class="mt-10">
                                <input type="text" name="first_name" placeholder="First Name"
                                       ...
                                       required="" class="single-input" value="{{old('first_name')}}">
                                @error('first_name')
                                <div class="mt-10 alert alert-danger">{{$message}}
                                </div>
                                @enderror
                            </div>
                            <div class="mt-10">
                                <input type="text" name="last_name" placeholder="Last Name"
                                       ...
                                       required="" class="single-input" value="{{old('last_name')}}">
                                @error('last_name')
                                <div class="mt-10 alert alert-danger">{{$message}}
                                </div>
                                @enderror
                            ...
                            <div class="mt-10">
                                <input type="text" name="mobile_number" placeholder="Mobile Number"
                                       ...
                                       required="" class="single-input" value="{{old('mobile_number')}}">
                                @error('mobile_number')
                                <div class="mt-10 alert alert-danger">{{$message}}
                                </div>
                                @enderror
                            ...
                            <div class="mt-10">
                                <input type="email" name="email" placeholder="Email address"
                                       ...
                                       required="" class="single-input" value="{{old('email')}}">
                                @error('email')
                                <div class="mt-10 alert alert-danger">{{$message}}
                                </div>
                                @enderror
                            ...
                            <div class="input-group-icon mt-10">
                                ...
                                <div class="form-select" id="default-select">
                                    <select name="city">
                                        ...
                                        <option value="khanyonis">Khan Younis</option>
                                        <option value="rafah">Rafah</option>
                                        <option value="der-el-balah">Der El-Balah</option>
                                        <option value="el-shamal">El-Shamal</option>
                                        <option value="el-wosta">El-Wosta</option>
                                    </select>
                                </div>
                                @error('city')
                                <div class="mt-10 alert alert-danger">{{$message}}</div>
                                @enderror
                            </div>
                            <div class="mt-10">
                                <input type="text" name="area_name" placeholder="Area name"
                                       onfocus="this.placeholder = ''" onblur="this.placeholder = 'Area name'"
                                       required="" class="single-input" value="{{old('area_name')}}">
                                @error('area_name')
                                <div class="mt-10 alert alert-danger">{{$message}}</div>
                                @enderror
                            </div>
                            <div class="mt-10">
                                <input type="text" name="street_name" placeholder="Street name"
                                       onfocus="this.placeholder = ''" onblur="this.placeholder = 'Street name'"
                                       required="" class="single-input" value="{{old('street_name')}}">
                                @error('street_name')
                                <div class="mt-10 alert alert-danger">{{$message}}
                                </div>
                                @enderror
